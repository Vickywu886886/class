...
const Layout = ({ children }) => {
  ...
  // 根据用户角色选择菜单项
  const menuItems = user ? (user.isTeacher ? teacherMenuItems : studentMenuItems) : baseMenuItems;
                  ...
                  <Tooltip title="打开设置">
                    <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                      <Avatar
                        ...
                        src={user.avatar}
                        sx={{ 
                          bgcolor: user.isTeacher ? '#2196f3' : '#81c784',
        ...
        >
          {user && (
            <Box sx={{ 
              ...
              <Chip
                label={user.isTeacher ? '教师' : '学生'}
                sx={{ 
                  mt: 1,
                  bgcolor: 'rgba(255,255,255,0.9)',
                  color: user.isTeacher ? '#2196f3' : '#4caf50',
                  fontWeight: 'bold'
                }}
              />
            </Box>
              ...
              <ListItem key={item.text} disablePadding>
                <ListItemButton
                  ...
                  sx={{
                    ...
                    borderRadius: '10px',
                    '&:hover': {
                      bgcolor: user?.isTeacher ? '#e3f2fd' : '#e8f5e9',
                    }
                  }}
                >
                  <ListItemIcon sx={{ 
