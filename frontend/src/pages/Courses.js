...
const categories = [
  ...
  },
  {
    ...
    color: '#2196f3',
    subCategories: [
      { id: 'english-basic', name: '零基础启蒙' },
      { id: 'english-reading', name: '绘本阅读' },
      { id: 'english-exam', name: '考级课程' },
      { id: 'english-phonics', name: '自然拼读' },
      { id: 'english-speaking', name: '口语对话' },
      { id: 'english-advanced', name: '高阶精读' },
      { id: 'english-literature', name: '文学精读' },
      { id: 'english-chess', name: '国际象棋' },
      { id: 'english-science', name: '科学课程' },
      { id: 'english-history', name: '牛津历史' },
      { id: 'english-math', name: 'IB数学' },
    ]
  },
  {
    id: 'spanish',
    name: '西语课程',
    icon: <CelebrationIcon sx={{ fontSize: 30 }} />,
    color: '#ff9800',
    subCategories: [
      { id: 'spanish-basic', name: '零基础启蒙' },
      { id: 'spanish-reading', name: '绘本阅读' },
      { id: 'spanish-exam', name: '考级课程' },
      { id: 'spanish-phonics', name: '自然拼读' },
      { id: 'spanish-speaking', name: '口语对话' },
      { id: 'spanish-advanced', name: '高阶精读' },
      { id: 'spanish-literature', name: '文学精读' },
    ]
  },
  {
    id: 'french',
    ...
    color: '#e91e63',
    subCategories: [
      { id: 'french-basic', name: '零基础启蒙' },
      { id: 'french-reading', name: '绘本阅读' },
      { id: 'french-exam', name: '考级课程' },
      { id: 'french-phonics', name: '自然拼读' },
      { id: 'french-speaking', name: '口语对话' },
      { id: 'french-advanced', name: '高阶精读' },
      { id: 'french-literature', name: '文学精读' },
    ]
  },
];
            ...
            <DialogContent>
              ...
              <Box sx={{
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6}>
                    <Typography variant="body2">
                      时长：{selectedCourse.duration}
                    </Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography variant="body2">
                      学员数：{selectedCourse.students}人
                    </Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography variant="body2">
