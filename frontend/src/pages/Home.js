  ...
  english: [
    {
      ...
      audioIntro: '/audio/sarah-intro.mp3',
      introduction: '大家好！我是Sarah，来自美国波士顿。我有5年的英语教学经验，擅长教授幼儿和小学生英语。我的教学方式生动有趣，善于调动学生的学习积极性。',
      certificates: [
        {
          name: 'TESOL证书',
          issuer: '剑桥大学',
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment: '老师很耐心，课程内容生动有趣，孩子很喜欢上课。',
          date: '2024-03-15'
        },
        {
          id: 2,
...
const Home = () => {
  ...
  // 处理关注/取消关注
  const handleFollowTeacher = (teacherId, event) => {
    event.stopPropagation(); // 防止触发教师卡片点击
    setFollowedTeachers(prev => {
      const newFollowed = prev.includes(teacherId)
        ? prev.filter(id => id !== teacherId)
        : [...prev, teacherId];

      // 保存到localStorage
      localStorage.setItem('followedTeachers', JSON.stringify(newFollowed));
